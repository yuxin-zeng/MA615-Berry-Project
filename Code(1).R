...
## read the data
berries=read_csv("C:/Users/shuangping.yang/Desktop/berries.csv",col_names=T)
...
write.csv(rberry,file="C:/Users/lenovo/Desktop/615 R/berry/rberry.csv")
sberry=berries%>%filter(Commodity=="STRAWBERRIES")
write.csv(sberry,file="C:/Users/lenovo/Desktop/615 R/berry/sberry.csv")
...
#year- value
boxplot(Value~Year,data=bberry,xlab='year',ylab='value')
